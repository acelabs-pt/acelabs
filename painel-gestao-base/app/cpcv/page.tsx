...
function tempoMedioConclusao(processos: Processo[]): string {
  const concluidos = processos.filter((p) => p.estado === "aprovado");
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <PlotlyChart
              ...
              data={[
                {
                  type: "pie",
                  labels: [ESTADO_LABEL.em_preenchimento, ESTADO_LABEL.pronto_para_aprovacao, ESTADO_LABEL.aprovado],
                  values: [contagens.em_preenchimento, contagens.pronto_para_aprovacao, contagens.aprovado],
                  marker: { colors: ["#ff9f0a", "#0071e3", "#1fae5a"] },
                  hole: 0.55,
